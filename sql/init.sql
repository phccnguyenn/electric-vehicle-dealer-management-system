...
--========================== DEALER INFO ==================================
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'dbo.dealer') AND type = 'U')
BEGIN
    CREATE TABLE dbo.dealer (
        id                  BIGINT IDENTITY(1, 1) PRIMARY KEY,
        dealer_level_id     BIGINT NOT NULL,
        dealer_name         NVARCHAR(150) NOT NULL,
        dealer_phone        VARCHAR(10) NOT NULL UNIQUE,
        location            NVARCHAR(255) NULL,
        contract_file_url   NVARCHAR(255) NULL,
        created_by          NVARCHAR(100) NULL,
        created_on          DATETIMEOFFSET NULL,
        last_modified_by    NVARCHAR(100) NULL,
        last_modified_on    DATETIMEOFFSET NULL,

        CONSTRAINT FK_dealer_level_id FOREIGN KEY (dealer_level_id)
...
VALUES
    (1, N'Đại lý Sài Gòn', '0999111888', N'123 Nguyễn Huệ, Q1, TP. HCM', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/contract_and_quotation/registry-contract-1.pdf', N'Lê Lý Thị Mộng', '2025-11-24 15:12:30.271071 +07:00', N'Lê Lý Thị Mộng', '2025-11-24 15:12:30.271071 +07:00'),
    (1, N'Đại lý Hà Nội', '0888999111', N'Số 25 Hai Bà Trưng, Quận Hoàn Kiếm, Hà Nội', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/contract_and_quotation/registry-contract-2.pdf', N'Lê Lý Thị Mộng', '2025-11-24 15:12:30.271071 +07:00', N'Lê Lý Thị Mộng', '2025-11-24 15:12:30.271071 +07:00'),
    (2, N'Đại lý Quy Nhơn', '0990988888', N'Số 10 Trần Hưng Đạo, TP. Quy Nhơn, Bình Định', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/contract_and_quotation/registry-contract-3.pdf', N'Lê Lý Thị Mộng', '2025-11-24 15:12:30.271071 +07:00', N'Lê Lý Thị Mộng', '2025-11-24 15:12:30.271071 +07:00');
...
CREATE TABLE dbo.car_detail (
    ...
    engine_number       VARCHAR(20) UNIQUE NOT NULL,
...
BEGIN
    ...
    VALUES
    (1, 1, 1, 'Sedan LX', 'FOR_SALE', N'Xanh', '1HGCM82633A004352', '2ZRFE183920', 'EVD Administrator', GETDATE(), 'EVD Administrator', GETDATE()),
...
BEGIN
    ...
    VALUES
    (1, 'sample_blue_01.jpg', '/uploads/thumbnail/image/sample_blue_01.jpg', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/sample_blue_01.jpg'),
    (1, 'sample_blue_02.jpg', '/uploads/thumbnail/image/sample_blue_02.jpg', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/sample_blue_02.jpg'),
    (1, 'sample_blue_03.jpg', '/uploads/thumbnail/image/sample_blue_03.jpg', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/sample_blue_03.jpg'),
    (1, 'sample_blue_01.jpg', '/uploads/thumbnail/image/sample_blue_01.jpg', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/sample_blue_interior_01.jpg'),
    (1, 'sample_blue_02.jpg', '/uploads/thumbnail/image/sample_blue_02.jpg', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/sample_blue_interior_02.jpg'),
    (1, 'sample_blue_03.jpg', '/uploads/thumbnail/image/sample_blue_03.jpg', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/sample_blue_interior_03.jpg'),

    (2, 'black_gold_01.png', '/uploads/thumbnail/image/black_gold_01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/black_gold_01.png'),
    (2, 'black_gold_02.png', '/uploads/thumbnail/image/black_gold_02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/black_gold_02.png'),
    (2, 'black_gold_03.png', '/uploads/thumbnail/image/black_gold_03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/black_gold_03.png'),
    (2, 'black_gold_intorior_01.png', '/uploads/thumbnail/image/black_gold_intorior_01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/black_gold_intorior_01.png'),
    (2, 'black_gold_intorior_02.png', '/uploads/thumbnail/image/black_gold_intorior_02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/black_gold_intorior_02.png'),
    (2, 'black_gold_intorior_03.png', '/uploads/thumbnail/image/black_gold_intorior_03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/black_gold_intorior_03.png'),

    (3, 'black_orange_01.png', '/uploads/thumbnail/image/black_orange_01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/black_orange_01.png'),
    (3, 'black_orange_02.png', '/uploads/thumbnail/image/black_orange_02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/black_orange_02.png'),
    (3, 'black_orange_03.png', '/uploads/thumbnail/image/black_orange_03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/black_orange_03.png'),
    (3, 'black_orange_Interior_01.png', '/uploads/thumbnail/image/black_orange_Interior_01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/black_orange_Interior_01.png'),
    (3, 'black_orange_Interior_02.png', '/uploads/thumbnail/image/black_orange_Interior_02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/black_orange_Interior_02.png'),
    (3, 'black_orange_Interior_03.png', '/uploads/thumbnail/image/black_orange_Interior_03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/black_orange_Interior_03.png'),

    (4, 'black_pink_01.png', '/uploads/thumbnail/image/black_pink_01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/black_pink_01.png'),
    (4, 'black_pink_02.png', '/uploads/thumbnail/image/black_pink_02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/black_pink_02.png'),
    (4, 'black_pink_03.png', '/uploads/thumbnail/image/black_pink_03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/black_pink_03.png'),
    (4, 'black_pink_interior_01.png', '/uploads/thumbnail/image/black_pink_interior_01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/black_pink_interior_01.png'),
    (4, 'black_pink_interior_02.png', '/uploads/thumbnail/image/black_pink_interior_02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/black_pink_interior_02.png'),
    (4, 'black_pink_interior_03.png', '/uploads/thumbnail/image/black_pink_interior_03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/black_pink_interior_03.png'),

    (5, 'blue_light_01.png', '/uploads/thumbnail/image/blue_light_01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/blue_light_01.png'),
    (5, 'blue_light_02.png', '/uploads/thumbnail/image/blue_light_02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/blue_light_02.png'),
    (5, 'blue_light_03.png', '/uploads/thumbnail/image/blue_light_03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/blue_light_03.png'),
    (5, 'blue_light_04.png', '/uploads/thumbnail/image/blue_light_04.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/blue_light_04.png'),
    (5, 'blue_light_interior_01.png', '/uploads/thumbnail/image/blue_light_interior_01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/blue_light_interior_01.png'),
    (5, 'blue_light_interior_02.png', '/uploads/thumbnail/image/blue_light_interior_02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/blue_light_interior_02.png'),
    (5, 'blue_light_interior_03.png', '/uploads/thumbnail/image/blue_light_interior_03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/blue_light_interior_03.png'),

    (6, 'green_brown_01.png', '/uploads/thumbnail/image/green_brown_01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/green_brown_01.png'),
    (6, 'green_brown_04.png', '/uploads/thumbnail/image/green_brown_04.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/green_brown_04.png'),
    (6, 'green_brown_interior_01.png', '/uploads/thumbnail/image/green_brown_interior_01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/green_brown_interior_01.png'),
    (6, 'green_brown_interior_02.png', '/uploads/thumbnail/image/green_brown_interior_02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/green_brown_interior_02.png'),
    (6, 'green_brown_interior_03.png', '/uploads/thumbnail/image/green_brown_interior_03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/green_brown_interior_03.png'),

    (7, 'red_01.png', '/uploads/thumbnail/image/red_01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/red_01.png'),
    (7, 'red_02.png', '/uploads/thumbnail/image/red_02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/red_02.png'),
    (7, 'red_03.png', '/uploads/thumbnail/image/red_03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/red_03.png'),
    (7, 'red_04.png', '/uploads/thumbnail/image/red_04.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/red_04.png'),
    (7, 'red_05.png', '/uploads/thumbnail/image/red_05.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/red_05.png'),
    (7, 'red_interior_01.png', '/uploads/thumbnail/image/red_interior_01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/red_interior_01.png'),
    (7, 'red_interior_02.png', '/uploads/thumbnail/image/red_interior_02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/red_interior_02.png'),

    (8, 'white_01.png', '/uploads/thumbnail/image/white_01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/white_01.png'),
    (8, 'white_02.png', '/uploads/thumbnail/image/white_02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/white_02.png'),
    (8, 'white_03.png', '/uploads/thumbnail/image/white_03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/white_03.png'),
    (8, 'white_Interior_01.png', '/uploads/thumbnail/image/white_Interior_01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/white_Interior_01.png'),
    (8, 'white_Interior_02.png', '/uploads/thumbnail/image/white_Interior_02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/white_Interior_02.png'),
    (8, 'white_Interior_03.png', '/uploads/thumbnail/image/white_Interior_03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/white_Interior_03.png'),

    (9, 'yellow_01.png', '/uploads/thumbnail/image/yellow_01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/yellow_01.png'),
    (9, 'yellow_02.png', '/uploads/thumbnail/image/yellow_02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/yellow_02.png'),
    (9, 'yellow_03.png', '/uploads/thumbnail/image/yellow_03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/yellow_03.png'),
    (9, 'yellow_04.png', '/uploads/thumbnail/image/yellow_04.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/yellow_04.png'),
    (9, 'yellow_05.png', '/uploads/thumbnail/image/yellow_05.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/yellow_05.png'),
    (9, 'yellow_interior_01.png', '/uploads/thumbnail/image/yellow_interior_01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/yellow_interior_01.png'),
    (9, 'yellow_interior_02.png', '/uploads/thumbnail/image/yellow_interior_02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/yellow_interior_02.png'),
    (9, 'yellow_interior_03.png', '/uploads/thumbnail/image/yellow_interior_03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/yellow_interior_03.png'),

    (10, 'yellow_banana_01.png', '/uploads/thumbnail/image/yellow_banana_01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/yellow_banana_01.png'),
    (10, 'yellow_banana_02.png', '/uploads/thumbnail/image/yellow_banana_02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/yellow_banana_02.png'),
    (10, 'yellow_banana_intorior_01.png', '/uploads/thumbnail/image/yellow_banana_intorior_01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/yellow_banana_intorior_01.png'),
    (10, 'yellow_banana_intorior_02.png', '/uploads/thumbnail/image/yellow_banana_intorior_02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/yellow_banana_intorior_02.png'),
    (10, 'yellow_banana_intorior_03.png', '/uploads/thumbnail/image/yellow_banana_intorior_03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/yellow_banana_intorior_03.png'),

    (11, 'brown_01.png', '/uploads/thumbnail/image/brown_01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/brown_01.png'),
    (11, 'brown_02.png', '/uploads/thumbnail/image/brown_02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/brown_02.png'),
    (11, 'brown_03.png', '/uploads/thumbnail/image/brown_03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/brown_03.png'),
    (11, 'brown-interior-01.png', '/uploads/thumbnail/image/brown-interior-01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/brown-interior-01.png'),
    (11, 'brown-interior-02.png', '/uploads/thumbnail/image/brown-interior-02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/brown-interior-02.png'),
    (11, 'brown-interior-03.png', '/uploads/thumbnail/image/brown-interior-03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/brown-interior-03.png'),

    (12, 'green-01.png', '/uploads/thumbnail/image/green-01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/green-01.png'),
    (12, 'green-02.png', '/uploads/thumbnail/image/green-02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/green-02.png'),
    (12, 'green-03.png', '/uploads/thumbnail/image/green-03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/green-03.png'),
    (12, 'green-interior-01.png', '/uploads/thumbnail/image/green-interior-01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/green-interior-01.png'),
    (12, 'green-interior-02.png', '/uploads/thumbnail/image/green-interior-02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/green-interior-02.png'),
    (12, 'green-interior-03.png', '/uploads/thumbnail/image/green-interior-03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/green-interior-03.png'),

    (13, 'grey-01.png', '/uploads/thumbnail/image/grey-01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/grey-01.png'),
    (13, 'grey-02.png', '/uploads/thumbnail/image/grey-02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/grey-02.png'),
    (13, 'grey-03.png', '/uploads/thumbnail/image/grey-03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/grey-03.png'),
    (13, 'grey-interior-01.png', '/uploads/thumbnail/image/grey-interior-01.png', 'http://3.107.12.96:8000/evdealer/uploads/thumbnail/image/grey-interior-01.png'),
    (13, 'grey-interior-02.png', '/uploads/thumbnail/image/grey-interior-02.png', 'http://3.107.12.96:8000/evdealer/uploads/thumbnail/image/grey-interior-02.png'),
    (13, 'grey-interior-03.png', '/uploads/thumbnail/image/grey-interior-03.png', 'http://3.107.12.96:8000/evdealer/uploads/thumbnail/image/grey-interior-03.png'),

    (14, 'blue-01.png', '/uploads/thumbnail/image/blue-01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/blue-01.png'),
    (14, 'blue-02.png', '/uploads/thumbnail/image/blue-02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/blue-02.png'),
    (14, 'blue-03.png', '/uploads/thumbnail/image/blue-03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/blue-03.png'),
    (14, 'blue-interior-01.png', '/uploads/thumbnail/image/blue-interior-01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/blue-interior-01.png'),
    (14, 'blue-interior-02.png', '/uploads/thumbnail/image/blue-interior-02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/blue-interior-02.png'),
    (14, 'blue-interior-03.png', '/uploads/thumbnail/image/blue-interior-03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/blue-interior-03.png'),

    (15, 'black-01.png', '/uploads/thumbnail/image/black-01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/black-01.png'),
    (15, 'black-02.png', '/uploads/thumbnail/image/black-02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/black-02.png'),
    (15, 'black-03.png', '/uploads/thumbnail/image/black-03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/black-03.png'),
    (15, 'black-interior-01.png', '/uploads/thumbnail/image/black-interior-01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/black-interior-01.png'),
    (15, 'black-interior-02.png', '/uploads/thumbnail/image/black-interior-02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/black-interior-02.png'),
    (15, 'black-interior-03.png', '/uploads/thumbnail/image/black-interior-03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/black-interior-03.png'),

    (16, 'white-01.png', '/uploads/thumbnail/image/white-01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/white-01.png'),
    (16, 'white-02.png', '/uploads/thumbnail/image/white-02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/white-02.png'),
    (16, 'white-03.png', '/uploads/thumbnail/image/white-03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/white-03.png'),
    (16, 'white-interior-01.png', '/uploads/thumbnail/image/white-interior-01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/white-interior-01.png'),
    (16, 'white-interior-02.png', '/uploads/thumbnail/image/white-interior-02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/white-interior-02.png'),
    (16, 'white-interior-03.png', '/uploads/thumbnail/image/white-interior-03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/white-interior-03.png'),

    (17, 'Orange-01.png', '/uploads/thumbnail/image/Orange-01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/Orange-01.png'),
    (17, 'Orange-02.png', '/uploads/thumbnail/image/Orange-02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/Orange-02.png'),
    (17, 'Orange-03.png', '/uploads/thumbnail/image/Orange-03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/Orange-03.png'),
    (17, 'Orange-interior-01.png', '/uploads/thumbnail/image/Orange-interior-01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/Orange-interior-01.png'),
    (17, 'Orange-interior-02.png', '/uploads/thumbnail/image/Orange-interior-02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/Orange-interior-02.png'),
    (17, 'Orange-interior-03.png', '/uploads/thumbnail/image/Orange-interior-03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/Orange-interior-03.png'),

    (18, 'CopperMist-01.png', '/uploads/thumbnail/image/CopperMist-01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/CopperMist-01.png'),
    (18, 'CopperMist-02.png', '/uploads/thumbnail/image/CopperMist-02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/CopperMist-02.png'),
    (18, 'CopperMist-03.png', '/uploads/thumbnail/image/CopperMist-03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/CopperMist-03.png'),
    (18, 'CopperMist-interior-01.png', '/uploads/thumbnail/image/CopperMist-interior-01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/CopperMist-interior-01.png'),
    (18, 'CopperMist-interior-02.png', '/uploads/thumbnail/image/CopperMist-interior-02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/CopperMist-interior-02.png'),
    (18, 'CopperMist-interior-03.png', '/uploads/thumbnail/image/CopperMist-interior-03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/CopperMist-interior-03.png'),

    (19, 'GlossyBlack-01.png', '/uploads/thumbnail/image/GlossyBlack-01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/GlossyBlack-01.png'),
    (19, 'GlossyBlack-02.png', '/uploads/thumbnail/image/GlossyBlack-02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/GlossyBlack-02.png'),
    (19, 'GlossyBlack-03.png', '/uploads/thumbnail/image/GlossyBlack-03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/GlossyBlack-03.png'),
    (19, 'GlossyBlack-interior-01.png', '/uploads/thumbnail/image/GlossyBlack-interior-01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/GlossyBlack-interior-01.png'),
    (19, 'GlossyBlack-interior-02.png', '/uploads/thumbnail/image/GlossyBlack-interior-02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/GlossyBlack-interior-02.png'),
    (19, 'GlossyBlack-interior-03.png', '/uploads/thumbnail/image/GlossyBlack-interior-03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/GlossyBlack-interior-03.png'),

    (20, 'FrostBlue-01.png', '/uploads/thumbnail/image/FrostBlue-01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/FrostBlue-01.png'),
    (20, 'FrostBlue-02.png', '/uploads/thumbnail/image/FrostBlue-02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/FrostBlue-02.png'),
    (20, 'FrostBlue-03.png', '/uploads/thumbnail/image/FrostBlue-03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/FrostBlue-03.png'),
    (20, 'FrostBlue-interior-01.png', '/uploads/thumbnail/image/FrostBlue-interior-01.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/FrostBlue-interior-01.png'),
    (20, 'FrostBlue-interior-02.png', '/uploads/thumbnail/image/FrostBlue-interior-02.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/FrostBlue-interior-02.png'),
    (20, 'FrostBlue-interior-03.png', '/uploads/thumbnail/image/FrostBlue-interior-03.png', 'http://3.107.14.223:8000/evdealer/uploads/thumbnail/image/FrostBlue-interior-03.png');
END;
GO
...
BEGIN
    CREATE TABLE dbo.slot (
        id                  BIGINT IDENTITY(1,1) PRIMARY KEY,
        dealer_info_id      BIGINT NOT NULL,
        ...
        CONSTRAINT fk_slot_dealer_info_id
            FOREIGN KEY (dealer_info_id)
            REFERENCES dbo.dealer(id)
            ON UPDATE CASCADE
            ON DELETE CASCADE,
...
BEGIN
    INSERT INTO dbo.slot (dealer_info_id, dealer_staff_id, num_customers, start_time, end_time, created_by, created_on, last_modified_by, last_modified_on) VALUES
    (1, 4, 4, '2025-11-06T08:00:00+07:00', '2025-11-06T09:00:00+07:00', N'Đại lý Sài Gòn', GETDATE(), N'Đại lý Sài Gòn', GETDATE()),
    (1, 4, 2, '2025-11-06T09:30:00+07:00', '2025-11-06T10:30:00+07:00', N'Đại lý Sài Gòn', GETDATE(), N'Đại lý Sài Gòn', GETDATE()),
    (2, 6, 4, '2025-11-06T13:00:00+07:00', '2025-11-06T14:00:00+07:00', N'Đại lý Hà Nội', GETDATE(), N'Đại lý Hà Nội', GETDATE()),
    (2, 6, 4, '2025-11-15T13:00:00+07:00', '2025-11-16T14:00:00+07:00', N'Đại lý Hà Nội', GETDATE(), N'Đại lý Hà Nội', GETDATE()),
    (3, 8, 3, '2025-11-07T10:00:00+07:00', '2025-11-07T11:00:00+07:00', N'Đại lý Quy Nhơn', GETDATE(), N'Đại lý Quy Nhơn', GETDATE()),
    (3, 9, 5, '2025-11-07T15:00:00+07:00', '2025-11-07T16:00:00+07:00', N'Đại lý Quy Nhơn', GETDATE(), N'Đại lý Quy Nhơn', GETDATE()),
    (4, 11, 3, '2025-11-08T08:30:00+07:00', '2025-11-08T09:30:00+07:00', N'Đại lý Hải Phòng', GETDATE(), N'Đại lý Hải Phòng', GETDATE()),

    (1, 4, 4, '2025-11-24T08:00:00+07:00', '2025-11-24T09:00:00+07:00', N'Đại lý Sài Gòn', GETDATE(), N'Đại lý Sài Gòn', GETDATE()),
    (1, 4, 2, '2025-11-26T09:30:00+07:00', '2025-11-26T10:30:00+07:00', N'Đại lý Sài Gòn', GETDATE(), N'Đại lý Sài Gòn', GETDATE()),
    (3, 8, 3, '2025-11-26T10:00:00+07:00', '2025-11-26T11:00:00+07:00', N'Đại lý Quy Nhơn', GETDATE(), N'Đại lý Quy Nhơn', GETDATE()),
    (3, 9, 5, '2025-11-26T15:00:00+07:00', '2025-11-26T16:00:00+07:00', N'Đại lý Quy Nhơn', GETDATE(), N'Đại lý Quy Nhơn', GETDATE()),
    (1,  4, 5, '2025-11-25T14:00:00+07:00', '2025-11-25T15:30:00+07:00', N'Đại lý Sài Gòn', GETDATE(), N'Đại lý Sài Gòn', GETDATE());
END;
GO
...
BEGIN
    CREATE TABLE dbo.orders (
        ...
        CONSTRAINT FK_orders_dealer_id FOREIGN KEY (dealer_id) REFERENCES dealer(id),
...
BEGIN
    ...
    (1, NULL, 1, 4, 3, 2657000000.00, 0.00, NULL, NULL, N'PENDING', N'PENDING', N'Nguyễn Văn Quý', CAST('2025-11-12T16:04:00+07:00' AS DATETIMEOFFSET), N'Nguyễn Văn Quý', CAST('2025-11-12T16:04:00+07:00' AS DATETIMEOFFSET)),
    (1, NULL, 1, 4, 3, 2657000000.00, 0.00, NULL, NULL, N'PENDING', N'PENDING', N'Nguyễn Văn Quý', CAST('2025-11-09T16:04:00+07:00' AS DATETIMEOFFSET), N'Nguyễn Văn Quý', CAST('2025-11-09T16:04:00+07:00' AS DATETIMEOFFSET));
END
GO
...
BEGIN
    INSERT INTO dbo.orders_activities (order_id, order_status, changed_at)
        ...
        (2, 'PENDING', CAST('2025-11-05T16:04:00+07:00' AS DATETIMEOFFSET));
END;
GO
