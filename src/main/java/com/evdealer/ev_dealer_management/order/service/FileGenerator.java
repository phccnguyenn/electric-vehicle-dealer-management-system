...
//
//            table.addCell(new PdfPCell(new Phrase("Số khung", boldFont)));
//            table.addCell(new PdfPCell(new Phrase(car.getVinNumber(), normalFont)));
//
//            table.addCell(new PdfPCell(new Phrase("Số máy", boldFont)));
//            table.addCell(new PdfPCell(new Phrase(car.getEngineNumber(), normalFont)));
//
