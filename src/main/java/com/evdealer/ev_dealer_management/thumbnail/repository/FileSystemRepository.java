package com.evdealer.ev_dealer_management.thumbnail.repository;

import com.evdealer.ev_dealer_management.thumbnail.config.FilesystemConfig;
...
public class FileSystemRepository {
    ...
    private Path buildFilePath(String filename) {
        ...
        Path filePath = Paths.get(filesystemConfig.getDirectory(), filename);
